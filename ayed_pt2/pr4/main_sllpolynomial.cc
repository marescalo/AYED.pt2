...
int main()
{
  ...
  cout << "sllp1 :";
  sllp1.MostrarIntermedio();
  cout << "sllp2 :" ;
  sllp2.MostrarIntermedio();
  cout << "sllp3 :" ;
  sllp3.MostrarIntermedio();

  //resta

  SllPolynomial sllpResta12, sllpResta23;
  sllp1.Resta(sllp2, sllpResta12);
  cout << "sllp1 - sllp2= " << sllpResta12;
  sllp2.Resta(sllp3, sllpResta23);
  cout << "sllp2 - sllp3= " << sllpResta23;
  ...
  // muestra lo pares
  SllPolynomial sllpPares1, sllpPares3;
  cout << "sllp1= " << sllp1;
  cout << "sllp1 :";
  sllp1.Pares(sllpPares1);

  cout << "sllp3= " << sllp3;
  cout << "sllp3 :" ;
  sllp3.Pares(sllpPares3);
